            ...
            if id < 8:
                ...
                if to_show[0] == 'win':
                    temp = draw_text(f'''{str(games).strip("(").strip(")").replace(",", " ").replace("'", " ")}''',
                              screen_size[0] // 30, (255, 255, 255), screen, text_size[0], screen_size[1] * 0.1 + text_size[1] + text_size[1] * id)
                    pygame.draw.rect(screen, (142, 196, 250), (text_size[0], screen_size[1] * 0.1 + text_size[1] + text_size[1] * id, temp, text_size[1]), 0)
