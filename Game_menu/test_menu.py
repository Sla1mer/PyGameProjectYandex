...
class InputBox:
        ...
        if event.type == pygame.KEYDOWN:
            if self.active:
                if event.key == pygame.K_BACKSPACE:
                    ...
                    if draw_text(self.text, 20, (0, 170, 200), screen, self.rect.x + 5, self.rect.y + 5) + 10\
                            < box_size[0] - 10:
    ...
    def update(self):
        draw_text(self.text, 20, (0, 170, 200), screen, self.rect.x + 5, self.rect.y + 5) + 10
...
all_buttons.add(Button(menu_button_pos_x, menu_button_pos_y * 2,
                       "print('сделать')", 'button_start_game.png', button_size))

all_buttons.add(Button(menu_button_pos_x, menu_button_pos_y * 3,
                       "print('сделать')", 'button_change_deck.png', button_size))
...
all_buttons.add(Button(screen_size[0] - screen_size[0] // 3 - screen_size[1] // 16 + box_size[0] - box_size[0] // 4,
                       screen_size[1] - auth_button_size[1] * 4.2 - auth_button_size[1] // 4,
                       "reg(login.give_text(), password.give_text())", 'button_reg.png', auth_button_size))
